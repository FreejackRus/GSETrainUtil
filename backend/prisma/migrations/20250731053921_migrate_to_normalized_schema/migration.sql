/*
  ...
  - You are about to drop the column `equipmentPhoto` on the `requests` table. All the data in the column will be lost.
  - You are about to drop the column `equipmentType` on the `requests` table. All the data in the column will be lost.
  ...
  - You are about to drop the column `macAddress` on the `requests` table. All the data in the column will be lost.
  - You are about to drop the column `macPhoto` on the `requests` table. All the data in the column will be lost.
  - You are about to drop the column `serialNumber` on the `requests` table. All the data in the column will be lost.
  - You are about to drop the column `serialPhoto` on the `requests` table. All the data in the column will be lost.
